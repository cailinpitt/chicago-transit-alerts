        ...
        {incidents.map((incident) => {
          ...
          const headline =
            ...
            (incident.from_station && incident.to_station
              ...
              : 'Ongoing disruption');
          const content = (
            <div className="flex items-start gap-3 px-3 py-2.5 rounded-md border border-slate-200 dark:border-gh-border bg-white dark:bg-gh-surface hover:border-slate-300 dark:hover:border-slate-600 transition-colors">
